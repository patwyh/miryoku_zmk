...
&kp GRAVE  K10  K11  K12  K13  K14       K15  K16  K17  K18  K19  &kp SQT \
...
#if !defined (MIRYOKU_LAYER_BASE_CRABAPPLEPAD)

#define MIRYOKU_LAYER_BASE_CRABAPPLEPAD \
...
#define MIRYOKU_LAYER_BASE MIRYOKU_LAYER_BASE_CRABAPPLEPAD
